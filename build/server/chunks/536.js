...
/* harmony import */ var _ffmpeg_ffmpeg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5043);
/* harmony import */ var _ffmpeg_ffmpeg__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_ffmpeg_ffmpeg__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var react_toastify__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(3590);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6641);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([ipfs_http_client__WEBPACK_IMPORTED_MODULE_6__, react_toastify__WEBPACK_IMPORTED_MODULE_8__]);
([ipfs_http_client__WEBPACK_IMPORTED_MODULE_6__, react_toastify__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const fetchContract = (signerOrProvider)=>new ethers__WEBPACK_IMPORTED_MODULE_3__.ethers.Contract(_constants__WEBPACK_IMPORTED_MODULE_9__/* .DataMarketplaceAddress */ .z, _constants__WEBPACK_IMPORTED_MODULE_9__/* .DataMarketplaceABI */ .s, signerOrProvider);
...
const connectingWithSmartContract = async ()=>{
    try {
        ...
        react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Something went wrong while connecting with contract " + error, {
            closeOnClick: true,
            pauseOnHover: true,
            draggable: true,
            progress: undefined
...
const DataMarketplaceProvider = ({ children  })=>{
    ...
    const checkIfWalletConnected = async ()=>{
        try {
            if (!window.ethereum) react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Install MetaMask", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
            ...
            if (accounts.length) {
                ...
                react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("No Account Found", {
                    closeOnClick: true,
                    pauseOnHover: true,
                    draggable: true,
                    progress: undefined
    ...
    const connectWallet = async ()=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while connecting to wallet", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const getListingPrice = async ()=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while getting listing price", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const isOwnerOfMarket = async ()=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while checking role", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const hasTokenFromOwner = async ()=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while checking permissions!", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const getMarketBalance = async ()=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while getting balance", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const uploadToIPFS = async (file, type)=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error Uploading to IPFS", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const createData = async (name, price, image, thumbnail, description, dataType, router)=>{
        if (!name || !description || !price || !image || !dataType) return react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Data Is Missing!", {
            closeOnClick: true,
            pauseOnHover: true,
            draggable: true,
            progress: undefined
        ...
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while creating Data!", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const createSale = async (url, formInputPrice, dataType, isReselling, id)=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while creating sale. Please try again!", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const fetchDatas = async ()=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while fetching DataS", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const fetchMyDatasOrListedDatas = async (type)=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error while fetching listed Datas", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
    ...
    const buyData = async (Data)=>{
        try {
            ...
            react_toastify__WEBPACK_IMPORTED_MODULE_8__.toast.error("Error While buying Data", {
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
                progress: undefined
