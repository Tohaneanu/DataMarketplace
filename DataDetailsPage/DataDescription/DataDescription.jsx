    ...
    <div className={Style.DataDescription}>
      <div className={Style.DataDescription_box}>
        ...
        <div className={Style.DataDescription_box_share}>
          {/* <div className={Style.DataDescription_box_share_box}>
            <BsThreeDots
              className={Style.DataDescription_box_share_box_icon}
              onClick={() => openDataMenu()}
            />

            {DataMenu && (
              <div className={Style.DataDescription_box_share_box_social}>
                <a href="#">
